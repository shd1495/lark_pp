...
public class UploadController {
	...
	/*
	 * @PostMapping("/uploadFormAction") public void uploadFormPost(MultipartFileVO
	 * vo, Model model) {
	 * 
	 ...
	 * 
	 * try { vo.getImg1().transferTo(saveFile); } catch (Exception e) {
	 * e.printStackTrace(); }
	 * 
	 * System.out.println("-----------------"); System.out.println("자기소개서 :" +
	 * vo.getImg2().getOriginalFilename()); System.out.println("Upload File Size:" +
	 * vo.getImg2().getSize());
	 * 
	 * saveFile = new File(uploadFolder, vo.getImg2().getOriginalFilename());
	 * 
	 * try { vo.getImg2().transferTo(saveFile); } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
